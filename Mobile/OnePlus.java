	...
	public  OnePlus()
     {
       ...
       JLabel l3 = new JLabel("OnePlus Nord N20");
	   l3.setBounds(80,420,150,20);
       JLabel l4 = new JLabel("OnePlus 7 Pro");
	   l4.setBounds(330,420,100,20);
       JLabel l5 = new JLabel("OnePlus 8 Pro");
	   l5.setBounds(580,420,100,20);
	   JLabel l6 = new JLabel("OnePlus 9 Pro");
	   l6.setBounds(80,662,100,20);
       JLabel l7 = new JLabel("Oppo A16e");
	   l7.setBounds(330,660,100,20);
       JLabel l8 = new JLabel("Oppo A54 ");
	   ...
	   JButton b15 = new JButton("1 - 30,000");
        ...
        JButton b2 = new JButton(new ImageIcon("image//One7.jpg"));
        ...
        JButton b3 = new JButton(new ImageIcon("image//Nord20.jpg"));
        ...
        JButton b4 = new JButton(new ImageIcon("image//one8.jpg"));
        ...
        JButton b5 = new JButton(new ImageIcon("image//one9.jpg"));
