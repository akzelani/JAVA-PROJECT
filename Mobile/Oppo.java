...
public class Oppo {
	 ...
	 public  Oppo()
     {
       ...
       JLabel l4 = new JLabel("Oppo F21 Pro");
	   l4.setBounds(330,420,100,20);
       JLabel l5 = new JLabel("Oppo Reno6");
	   ...
	   JButton b8 = new JButton("Oppo");
        ...
        JButton b2 = new JButton(new ImageIcon("image//OppoF21Pro.jpg"));
        ...
        JButton b4 = new JButton(new ImageIcon("image//OppoReno6.jpg"));
        ...
        JButton b6 = new JButton(new ImageIcon("image//OppoA16e.jpg"));
        ...
        JButton b7 = new JButton(new ImageIcon("image//OppoA54.jpg"));
