	...
	public  Vivo()
     {
	   ...
	   JLabel l3 = new JLabel("Vivo X 80");
	   l3.setBounds(80,420,100,20);
       JLabel l4 = new JLabel("Vivo V23 5G");
	   l4.setBounds(330,420,100,20);
       JLabel l5 = new JLabel("Vivo X70 Pro");
	   l5.setBounds(580,420,100,20);
	   JLabel l6 = new JLabel("Vivo X60 Pro");
	   ...
	   JButton b8 = new JButton("Oppo");
        ...
        JButton b2 = new JButton(new ImageIcon("image//VivoV23.jpg"));
        ...
        JButton b3 = new JButton(new ImageIcon("image//VivoX80.jpg"));
        ...
        JButton b4 = new JButton(new ImageIcon("image//VivoX70Pro.jpg"));
        ...
        JButton b5 = new JButton(new ImageIcon("image//VivoX60Pro5G.jpg"));
