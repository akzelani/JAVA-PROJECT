	...
	public  Apple()
     {
       ...
       JLabel l3 = new JLabel("iPhone 13 ");
	   l3.setBounds(80,420,100,20);
       JLabel l4 = new JLabel("iPhone12");
	   l4.setBounds(330,420,100,20);
       JLabel l5 = new JLabel("iPhone11");
	   l5.setBounds(580,420,100,20);
	   JLabel l6 = new JLabel("iPhone X");
	   ...
	   JButton b8 = new JButton("Oppo");
        ...
        JButton b2 = new JButton(new ImageIcon("image//iPhone12.jpg"));
        ...
        JButton b3 = new JButton(new ImageIcon("image//iPhone13.jpg"));
        ...
        JButton b4 = new JButton(new ImageIcon("image//iPhone11.jpg"));
        ...
        JButton b5 = new JButton(new ImageIcon("image//iPhone10.jpg"));
